...
def get_official_eval_result_new(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    # Define overlap thresholds for the three IOU thresholds
    # IOU thresholds for 0.7, 0.5, and 0.3 for Car
    # For other classes, keep existing thresholds
    overlap_0_7 = np.array([
        [0.7, 0.5, 0.5, 0.7, 0.5, 0.7],  # Easy difficulty
        [0.7, 0.5, 0.5, 0.7, 0.5, 0.7],  # Moderate difficulty
        [0.7, 0.5, 0.5, 0.7, 0.5, 0.7]   # Hard difficulty
    ])
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    overlap_0_5 = np.array([[0.5, 0.5, 0.5, 0.5,
                            ...
                            [0.5, 0.25, 0.25, 0.5, 0.25, 0.5]])
    overlap_0_3 = np.array([[0.3, 0.5, 0.5, 0.3,
                             0.5, 0.5], [0.3, 0.25, 0.25, 0.3, 0.25, 0.5],
                            [0.3, 0.25, 0.25, 0.3, 0.25, 0.5]])
